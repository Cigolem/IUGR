...
save('C:\Users\Cigdem\MATLAB Drive\baby EEG\Baby Files\scripts for manuscript\GITHUB\PSD_Control.mat');

% Generate frequency array to use for plotting and save 
[~ , freq_PSD] = PSD_CG(REM_Control{1,1}{1,1}(1,:));
save('C:\Users\Cigdem\MATLAB Drive\baby EEG\Baby Files\scripts for manuscript\GITHUB\freq_PSD.mat');
...
save('C:\Users\Cigdem\MATLAB Drive\baby EEG\Baby Files\scripts for manuscript\GITHUB\PSD_Control_av.mat');
